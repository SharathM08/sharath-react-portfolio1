...
export const ContactUs = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    emailjs
        .send(
            "service_sbw14sg",      // ✅ Your EmailJS service ID
            "template_upmhe7g",     // ✅ Your EmailJS template ID
            formData,               // ✅ Form data (must match template variables)
            "muBnUG8C_27owN18B"     // ✅ Your EmailJS public key
        )
        .then(
            (result) => {
  ...
  return (
      <>
        <div id="Contact" className="min-h-screen">
          <div className="project-title text-7xl md:text-9xl min-h-screen tracking-wide font-extrabold leading-snug uppercase text-white flex items-center md:justify-center">
          ...
          <div className="form py-10 px-3 flex max-md:flex-col mt-10 gap-5">
